...
const HeroButton = ({ onClick }: { onClick: () => void }) => {
  return (
    <button onClick={onClick} className="relative block w-full">
      ...
      <span className="text-[14px] px-[24px] rounded-[16px] h-[28px] absolute left-1/2 -translate-x-1/2 -translate-y-[50%] top-[0] flex items-center justify-center gap-[4px] bg-[#3B2A27] rounded-[10px]">
